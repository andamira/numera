    ...
    ($rhs:ident) => {
        impl<N: Number + Signed + Add<Output = N>> Add<$rhs<N>> for NonZeroInteger<N> {
            ...
            fn add(self, other: $rhs<N>) -> Self::Output {
                NonZeroInteger::new(self.0.add(other.0)) // panics if == 0
            }
        }
    };
}
...
#[rustfmt::skip]
impl_add_n0z_smaller_integer![for_all_integers: "",
    (i16, i8),
    (i32, i16), (i32, i8),
...
mod add_ibig {
    ...
    impl Add<IBig> for NonZeroInteger<IBig> {
        ...
        fn add(self, other: IBig) -> NonZeroInteger<IBig> {
            NonZeroInteger::new(self.0.add(other))
        }
    }
