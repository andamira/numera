...
// from_rational![non0 for:Rational+i+8, from:NonZeroRational+8];
// from_rational![non0 for:Rational+i+16, from:NonZeroRational+8,16];
// from_rational![non0 for:Rational+i+32, from:NonZeroRational+8,16,32];
// from_rational![non0 for:Rational+i+128, from:NonZeroRational+8,16,32,64,128];
// // try_from bigger NonZeroRational
// try_from_rational![non0 for:Rational+i+8, from:NonZeroRational+16,32,64,128];
// try_from_rational![non0 for:Rational+i+16, from:NonZeroRational+32,64,128];
// try_from_rational![non0 for:Rational+i+32, from:NonZeroRational+64,128];
// try_from_rational![non0 for:Rational+i+64, from:NonZeroRational+128];
...
// try_from_rational![non0 for:Rational+i+8, from:NonNegativeRational+16,32,64,128];
// try_from_rational![non0 for:Rational+i+16, from:NonNegativeRational+32,64,128];
// try_from_rational![non0 for:Rational+i+32, from:NonNegativeRational+64,128];
// try_from_rational![non0 for:Rational+i+64, from:NonNegativeRational+128];

// // from smaller sized PositiveRational
// from_rational![non0 for:Rational+i+16, from:Pq+8];
// from_rational![non0 for:Rational+i+32, from:Pq+8,16];
// from_rational![non0 for:Rational+i+64, from:Pq+8,16,32];
// from_rational![non0 for:Rational+i+128, from:Pq+8,16,32,64];
// // try_from bigger PositiveRational
// try_from_rational![non0 for:Rational+i+8, from:PositiveRational+16,32,64,128];
// try_from_rational![non0 for:Rational+i+16, from:PositiveRational+32,64,128];
// try_from_rational![non0 for:Rational+i+32, from:PositiveRational+64,128];
// try_from_rational![non0 for:Rational+i+64, from:PositiveRational+128];
...
// try_from_rational![non0 for:Rational+i+8, from:NonPositiveRational+16,32,64,128];
// try_from_rational![non0 for:Rational+i+16, from:NonPositiveRational+32,64,128];
// try_from_rational![non0 for:Rational+i+32, from:NonPositiveRational+64,128];
// try_from_rational![non0 for:Rational+i+64, from:NonPositiveRational+128];

// // from smaller sized NegativeRational
// from_rational![non0_neg for:Rational+i+16, from:NonNegativeRational+8];
// from_rational![non0_neg for:Rational+i+32, from:NonNegativeRational+8,16];
// from_rational![non0_neg for:Rational+i+64, from:NonNegativeRational+8,16,32];
// from_rational![non0_neg for:Rational+i+128, from:NonNegativeRational+8,16,32,64];
// // try_from bigger NegativeRational
// try_from_rational![non0 for:Rational+i+8, from:NegativeRational+16,32,64,128];
// try_from_rational![non0 for:Rational+i+16, from:NegativeRational+32,64,128];
// try_from_rational![non0 for:Rational+i+32, from:NegativeRational+64,128];
// try_from_rational![non0 for:Rational+i+64, from:NegativeRational+128];
