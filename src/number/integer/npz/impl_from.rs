...
try_from_integer![int for: NonPositiveInteger+8, from: Integer+8,16,32,64,128];
try_from_integer![int for: NonPositiveInteger+16, from: Integer+8,16,32,64,128];
try_from_integer![int for: NonPositiveInteger+32, from: Integer+8,16,32,64,128];
try_from_integer![int for: NonPositiveInteger+64, from: Integer+8,16,32,64,128];
try_from_integer![int for: NonPositiveInteger+128, from: Integer+8,16,32,64,128];

// try_from NonZeroInteger (only the negative values)
try_from_integer![nonzero for: NonPositiveInteger+8, from: NonZeroInteger+8,16,32,64,128];
try_from_integer![nonzero for: NonPositiveInteger+16, from: NonZeroInteger+8,16,32,64,128];
try_from_integer![nonzero for: NonPositiveInteger+32, from: NonZeroInteger+8,16,32,64,128];
try_from_integer![nonzero for: NonPositiveInteger+64, from: NonZeroInteger+8,16,32,64,128];
try_from_integer![nonzero for: NonPositiveInteger+128, from: NonZeroInteger+8,16,32,64,128];
...
mod tests {
    ...
    fn npz_from() -> NumeraResult<()> {
        ...
        // try_from i (only the non-positive values)
        // assert_eq![Npz8::new(100), (-100_i8).try_into()?]; // FIX
        // assert_eq![Npz8::new(100), TryInto::<Npz8>::try_into(-100_i8)?]; // DELETE

        // assert_eq![Npz8::new(100)?, 100_i16.try_into()?];
        // assert_eq![Npz16::new(100)?, 100_i8.try_into()?];
        // assert![TryInto::<Npz8>::try_into(0_i16).is_err()];
        // assert![TryInto::<Npz8>::try_into(200_i16).is_err()];
        ...
        // try_from NonZeroInteger (only the negative values) // CHECK
