...
//     for: NegativeInteger + u + 8, from: PositiveInteger + 8];
// impl_from_integer![many_nonzero
//     for: NegativeInteger + u + 16, from: PositiveInteger + 8, 16];
// impl_from_integer![many_nonzero
//     for: NegativeInteger + u + 32, from: PositiveInteger + 8, 16, 32];
// impl_from_integer![many_nonzero
//     for: NegativeInteger + u + 64, from: PositiveInteger + 8, 16, 32, 64];
// impl_from_integer![many_nonzero
//     for: NegativeInteger + u + 128, from: PositiveInteger + 8, 16, 32, 64, 128];
