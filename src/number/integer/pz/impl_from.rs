...
impl_from_primitive![many_nonzero for: Pz + 8, from: NonZeroU + 8];
impl_from_primitive![many_nonzero for: Pz + 16, from: NonZeroU + 8, 16];
impl_from_primitive![many_nonzero for: Pz + 32, from: NonZeroU + 8, 16, 32];
impl_from_primitive![many_nonzero for: Pz + 64, from: NonZeroU + 8, 16, 32, 64];
impl_from_primitive![many_nonzero for: Pz + 128, from: NonZeroU + 8, 16, 32, 64, 128];

// from smaller sized PositiveInteger (Self)
impl_from_integer![many_nonzero for: Pz + u + 16, from: Pz + 8];
impl_from_integer![many_nonzero for: Pz + u + 32, from: Pz + 8, 16];
impl_from_integer![many_nonzero for: Pz + u + 64, from: Pz + 8, 16, 32];
impl_from_integer![many_nonzero for: Pz + u + 128, from: Pz + 8, 16, 32, 64];
