...
from_integer![nonzero for:NonZeroInteger+16, from:NonZeroInteger+8];
from_integer![nonzero for:NonZeroInteger+32, from:NonZeroInteger+8,16];
from_integer![nonzero for:NonZeroInteger+64, from:NonZeroInteger+8,16,32];
from_integer![nonzero for:NonZeroInteger+128, from:NonZeroInteger+8,16,32,64];
// try_from bigger NonZeroInteger (Self)
try_from_integer![nonzero for:NonZeroInteger+8, from:NonZeroInteger+16,32,64,128];
try_from_integer![nonzero for:NonZeroInteger+16, from:NonZeroInteger+32,64,128];
try_from_integer![nonzero for:NonZeroInteger+32, from:NonZeroInteger+64,128];
try_from_integer![nonzero for:NonZeroInteger+64, from:NonZeroInteger+128];

// from smaller PositiveInteger
from_integer![nonzero for:NonZeroInteger+16, from:PositiveInteger+8];
from_integer![nonzero for:NonZeroInteger+32, from:PositiveInteger+8,16];
from_integer![nonzero for:NonZeroInteger+64, from:PositiveInteger+8,16,32];
from_integer![nonzero for:NonZeroInteger+128, from:PositiveInteger+8,16,32,64];
// try_from bigger or equal sized PositiveInteger
try_from_integer![nonzero for:NonZeroInteger+8, from:PositiveInteger+8,16,32,64,128];
try_from_integer![nonzero for:NonZeroInteger+16, from:PositiveInteger+16,32,64,128];
try_from_integer![nonzero for:NonZeroInteger+32, from:PositiveInteger+32,64,128];
try_from_integer![nonzero for:NonZeroInteger+64, from:PositiveInteger+64,128];
try_from_integer![nonzero for:NonZeroInteger+128, from:PositiveInteger+128];
...
try_from_integer![int_new for:NonZeroInteger+8, from:Integer+8,16,32,64,128];
try_from_integer![int_new for:NonZeroInteger+16, from:Integer+8,16,32,64,128];
try_from_integer![int_new for:NonZeroInteger+32, from:Integer+8,16,32,64,128];
try_from_integer![int_new for:NonZeroInteger+64, from:Integer+8,16,32,64,128];
try_from_integer![int_new for:NonZeroInteger+128, from:Integer+8,16,32,64,128];

// try_from NonNegativeInteger (only the non-zero values)
try_from_integer![int_new for:NonZeroInteger+8, from:NonNegativeInteger+8,16,32,64,128];
try_from_integer![int_new for:NonZeroInteger+16, from:NonNegativeInteger+8,16,32,64,128];
try_from_integer![int_new for:NonZeroInteger+32, from:NonNegativeInteger+8,16,32,64,128];
try_from_integer![int_new for:NonZeroInteger+64, from:NonNegativeInteger+8,16,32,64,128];
try_from_integer![int_new for:NonZeroInteger+128, from:NonNegativeInteger+8,16,32,64,128];

// try_from NonPositiveInteger (only the non-zero values)
try_from_integer![int_new_neg for:NonZeroInteger+8, from:NonPositiveInteger+8,16,32,64,128];
try_from_integer![int_new_neg for:NonZeroInteger+16, from:NonPositiveInteger+8,16,32,64,128];
try_from_integer![int_new_neg for:NonZeroInteger+32, from:NonPositiveInteger+8,16,32,64,128];
try_from_integer![int_new_neg for:NonZeroInteger+64, from:NonPositiveInteger+8,16,32,64,128];
try_from_integer![int_new_neg for:NonZeroInteger+128, from:NonPositiveInteger+8,16,32,64,128];
