...
// try_from_primitive![int for:NonZeroInteger+16, from:u+8,16,32,64,128];// FIX Infallible
...
// try_from Integer
// try_from_integer![int for:NonZeroInteger+i+8, from:Z+16]; // FIX EXAMPLE :S
//
// try_from_integer![int for:NonZeroInteger+i+8, from:Z+8,16,32,64,128];
// try_from_integer![int for:NonZeroInteger+i+16, from:Z+8,16,32,64,128];
// try_from_integer![int for:NonZeroInteger+i+32, from:Z+8,16,32,64,128];
// try_from_integer![int for:NonZeroInteger+i+64, from:Z+8,16,32,64,128];
// try_from_integer![int for:NonZeroInteger+i+128, from:Z+8,16,32,64,128];
